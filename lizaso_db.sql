...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2024 at 12:33 PM
...
INSERT INTO `user_account` (`id`, `username`, `email`, `mobile_number`, `first_name`, `middle_name`, `last_name`, `isRole`, `isOnline`, `isStatus`, `isArchive`, `date_created`) VALUES
(2, 'admin', 'admin@example.com', '', 'Admin', '', 'User', 0, 0, 1, 0, '2024-08-13 18:18:16');
...
(2, 2, '$2b$10$O9GAri7tLGrs/gSXC4l9E.0UZYQMHKXc7.8Fx88SjtMjC0u0RrAZO', '$2b$10$rD0Z8W9fd8shVOPOm/tAhO', 0, '', 0, 0, '2024-08-13 10:18:16', NULL, NULL, NULL);
