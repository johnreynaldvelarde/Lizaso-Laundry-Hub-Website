  ...
  const fetchConversation = useCallback(async (conversationId) => {
    ...
    try {
      ...
      setSelectedConversation({
        ...
        messages, // Set messages directly from the response
      });
      setError(null);
    } catch (err) {
...
//   // Fetch inbox conversations or user list if no conversations exist
//   const fetchInbox = useCallback(async () => {
//     setLoading(true);
//     try {
//       const response = await axiosPrivate.get(`/inbox/${userId}/get-inbox`);
...
//     fetchConversation(conversationId); // Fetch the new one
//   };
...
//     error,
//     selectConversation,
//     fetchInbox, // In case you need to reload the inbox
//   };
// };
