...
//         const { userType } = response.data; // Assuming `userType` is part of the response
...
const PopupLogin = ({ showLoginPopup, setLoginShowPopup }) => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault(); // Ensure event object is received and prevent default form submission
