...
import { List, TextOutdent } from "@phosphor-icons/react";
  ...
  return (
    <Box className="sticky top-0 z-50 py-3 backdrop-blur-lg bg-white bg-opacity-80 border-b border-neutral-700/40">
      <Box className="container px-4 mx-auto flex items-center justify-between">
              ...
              >
                {customerLinks && customerLinks.length > 0 ? (
                  customerLinks.map((item, index) => (
                    <SideCustomerItem {...item} key={index} />
                  ))
                ) : (
                  <div>
        ...
        {/* <Box
          className="hidden md:flex space-x-8 font-medium text-sm md:text-base mr-5 ml-5"
          style={{ color: styles.textColor2 }}
        >
          {c_navItems.map((item, index) => (
            <Box
        ...
        <Box className="flex items-center space-x-3">
          ...
          <Box ml={3}>
            <Typography fontWeight="font-semibold" fontSize="small">
          ...
          >
            ...
            >
              ...
              <Button color="primary" onClick={handleClearAll} size="small">
                Clear All
              </Button>
            </Box>
            <Divider />
            {messages.length === 0 ? (
              ...
              messages.map((message, index) => (
                <MenuItem key={index} onClick={handleCloseMessage}>
                  <Avatar
                    src={message.avatar}
                  ...
                  />
                  <Box>
                    <Typography fontWeight="font-semibold">
                      {message.senderName}
                    </Typography>
            ...
            >
              <Typography color="primary">See All Messages</Typography>
            </MenuItem>
          </Menu>
          ...
          >
            ...
            <MenuItem onClick={handleClose}>
              <Settings /> <Typography ml={1}>Settings</Typography>
            </MenuItem>
            <Divider />
            <MenuItem onClick={handleLogout}>
              <Logout /> <Typography ml={1}>Logout</Typography>
            </MenuItem>
          </Menu>
        </Box>
      </Box>
