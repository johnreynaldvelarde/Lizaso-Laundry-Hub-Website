...
const PopAddNewServices = ({ open, onClose, refreshData }) => {
  ...
  return (
    ...
    >
      <CustomPopHeaderTitle
        ...
        subtitle={"Provide the details for the new service"}
        onClose={onClose}
      />
      <DialogContent>
        {/* Serivce Name */}
      ...
      <CustomPopFooterButton
        ...
        onClose={onClose}
        onSubmit={handleCreateNewServices}
        loading={loading}
      />
    </Dialog>
  );
...
export default PopAddNewServices;
