  ...
  return (
    ...
    >
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Grid container spacing={2}>
              ...
              {/* If GCash selected, no need for extra inputs */}
              {/* {selectedPayment === "GCash" && (
                <Typography variant="body1" sx={{ mt: 2 }}>
                  GCash will be used to complete the transaction.
                </Typography>
              )} */}
            </Grid>
          </Grid>
      ...
      <CustomPopFooterButton
        ...
        onClose={onClose}
        onSubmit={(e) => handleSubmit(service.service_id, e, selectedPayment)}
        loading={loading}
      />
...
//         label={"Submit Request"}
//         onClose={onClose}
//         onSubmit={(e) => handleSubmit(service.service_id, e)}
//         loading={loading}
//       />
