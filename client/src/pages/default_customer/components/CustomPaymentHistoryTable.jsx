...
import { CaretCircleDown, Receipt } from "@phosphor-icons/react";
import StatusTransactionCellTable from "../../../components/common/table/custom/StatusTransactionCellTable";
import CustomPaymentMethodDisplay from "../../../components/common/table/custom/CustomPaymentMethodDisplay";
import { motion } from "framer-motion"; // Import motion from framer-motion

const CustomPaymentHistoryTable = ({ tableData, loading }) => {
        ...
        <Table>
          <TableHead className="bg-[#F1F1F1] border-b">
            <TableRow>
              ...
              <TableCell sx={cellHeadStyles}>Transaction Code</TableCell>
                    ...
                    >
                      ...
                      >
                        ...
                        <Tooltip title="View Receipt" arrow>
                          <OutlinedIconButton
                          // onClick={() => handleToggleRow(data.transaction_id)}
                          >
                            <Receipt color={COLORS.error} weight="duotone" />
                          </OutlinedIconButton>
                        </Tooltip>
                      </TableCell>
                    </TableRow>
...
export default CustomPaymentHistoryTable;
